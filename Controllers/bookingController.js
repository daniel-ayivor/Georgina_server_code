...
//       customerPhone,
//       serviceType,
//       selectedFeatures, // NEW: Array of selected feature names
//       address,
//       date,
//       time,
//       duration,
...
//     console.log('Creating booking with serviceType:', serviceType);
...
//       selectedFeatures: featuresArray, // Store as JSON array
//       address,
//       date,
//       time,
//       duration: duration,
...
//         selectedFeatures: booking.selectedFeatures, // Include in response
//         date: booking.date,
//         time: booking.time,
...
// // Get user dashboard bookings data
// const getUserDashboardBookings = async (req, res) => {
//   try {
//     const customerEmail = req.user.email; // From authenticated user
    
//     const { 
//       page = 1, 
//       limit = 5, // Smaller limit for dashboard
//       status 
//     } = req.query;
...
// // Get recent bookings for dashboard (last 5 bookings)
...
//       limit: 3 // Limit for dashboard widget
//     });
...
// // Update booking status (Admin only) with enhanced email notifications
...
// // Update booking status (Admin only) with email notifications
// // const updateBooking = async (req, res) => {
// //   const { id } = req.params;
