...
// ⭐ IMPORT MODELS FROM INDEX.JS FIRST - This loads all associations
const { sequelize, User, Order, Booking, Customer, Product, Category, OrderItem } = require('./Models/index');
...
// ⭐ REMOVED OLD ASSOCIATION CODE - Now handled in models/index.js
...
app.listen(process.env.PORT, () => {
    ...
    console.log('🔗 Associations loaded from models/index.js');
});